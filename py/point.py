...
2. double underscore methods have meaning
...
# write another method that sets self.x and self.y to 0 and call it reset_to_origin
# outside of the class, try using the function on an instance of this class
# print out the result

# implement a distance_from_origin function that takes no arguments, but instead calculate the distance of the instance point to the origin
